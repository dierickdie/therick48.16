...
qk_tap_dance_action_t tap_dance_actions[] = {
  ...
  [MAKE]    = ACTION_TAP_DANCE_FN_ADVANCED(NULL, make_therick48_finished, make_therick48_reset),
...
*/
  ...
  [_QW] = LAYOUT_ortho_4x12_4x4(
    ...
    FN_TAB,     ALT_A,      KC_S,       KC_D,       GUI_F,      KC_G,       KC_H,       GUI_J,      KC_K,       KC_L,       KC_SCLN,    SFT_QUOT,        KC_P4,     KC_P5,      KC_P6,      KC_PPLS,
    KC_LSFT,    GUI_Z,      SFT_X,      KC_C,       KC_V,       KC_B,       KC_N,       KC_M,       KC_COMM,    KC_DOT,     KC_SLSH,    SFT_ENT,         KC_P1,     KC_P2,      KC_P3,      KC_PENT,
    KC_LGUI,    KC_LSFT,    KC_LCTRL,   KC_LALT,    LWR_BS,     FN3_BS,     FN_SPC,     RSE_SPC,    ALT_LEFT,   CTL_DOWN,   SFT_UP,     GUI_RGHT,        LWR_P0,    KC_PAST,    KC_PDOT,    KC_PSLS
  ),
...
/* Lower
  ...
  |-----------+-----------+-----------+-----------+-----------+-----------+-----------+-----------+-----------+-----------+-----------+-----------|    |-----------+-----------+-----------+-----------|
  |           |   Left    |    Down   |    Up     |   Right   |    ***    |   Raise   |   Calc    |     1     |     2     |     3     |   Enter   |    |   Home    |   Pg Dn   |   Pg Up   |    End    |
  |-----------+-----------+-----------+-----------+-----------+-----------+-----------+-----------+-----------+-----------+-----------+-----------|    |-----------+-----------+-----------+-----------|
  |           |           |           |           |   Lower   |           |           |   LWL0    |     0     |     *     |     .     |     /     |    |           |           |           |   LWL1    |
  '-----------------------------------------------------------------------------------------------------------------------------------------------'    '-----------------------------------------------'
*/
  ...
  [_LOWER] = LAYOUT_ortho_4x12_4x4(
    _______,    TD(LBKTS),  TD(RBKTS),  KC_MINS,    KC_EQL,     KC_NO,      KC_NO,      KC_BSPC,     KC_P7,     KC_P8,      KC_P9,      KC_PMNS,         KC_BSPC,    KC_PSLS,    KC_PAST,    KC_DEL,
    LWL0_TAB,   GUI_HOME,   KC_PGDN,    KC_PGUP,    LWL1_END,   KC_BSPC,    KC_F4,      KC_F2,       KC_P4,     KC_P5,      KC_P6,      KC_PPLS,         KC_LEFT,    KC_DOWN,    KC_UP,      KC_RIGHT,
    _______,    KC_LEFT,    KC_DOWN,    KC_UP,      KC_RGHT,    KC_NO,      _______,    _______,     KC_P1,     KC_P2,      KC_P3,      KC_PENT,         KC_HOME,    KC_PGDN,    KC_PGUP,    KC_END,
    _______,    _______,    _______,    _______,    _______,    _______,    _______,    LWL0_SPC,    KC_P0,     KC_PAST,    KC_PDOT,    KC_PSLS,         _______,    _______,    _______,    _______
  ),
    ...
    */
      ...
      [_LWL0] = LAYOUT_ortho_4x12_4x4(
        ...
        _______,    KC_LGUI,    KC_LSFT,    KC_LALT,    KC_DEL,     _______,    _______,    _______,    KC_LEFT,    KC_DOWN,    KC_UP,      KC_RIGHT,        _______,    _______,    _______,    _______,
    ...
    */
      ...
      [_LWL1] = LAYOUT_ortho_4x12_4x4(
        ...
        _______,    G_HOME,     _______,    _______,    _______,    _______,    _______,    _______,    KC_DLR,     KC_COMM,    KC_PERC,    _______,         _______,    _______,    _______,    _______,
        _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    KC_EXLM,    _______,    _______,    _______,         _______,    _______,    _______,    _______,
...
*/
  ...
  [_RAISE] = LAYOUT_ortho_4x12_4x4(
    ...
    KC_EXLM,    TD(EMAIL),  KC_HASH,    KC_DLR,     KC_PERC,    KC_CIRC,    KC_AMPR,    KC_ASTR,    KC_LPRN,    KC_RPRN,    KC_UNDS,    KC_PLUS,         _______,    _______,    _______,    _______,
    CAPS_L,     TD(TILDE),  _______,    _______,    _______,    _______,    _______,    _______,    KC_LBRC,    KC_RBRC,    TD(PIPE),   FN2,             _______,    _______,    _______,    _______,
    _______,    _______,    _______,    _______,    _______,    _______,    TG(1),      _______,    GUI_MPLY,   ALT_VOLD,   CTL_VOLU,   KC_MUTE,         _______,    _______,    _______,    _______
  ),
...
*/
  ...
  [_FN] = LAYOUT_ortho_4x12_4x4(
    ...
    _______,    KC_LGUI,    KC_LSFT,    KC_LALT,    KC_DEL,     _______,    _______,    CTL_LEFT,   KC_DOWN,    KC_UP,      CTL_RGHT,   KC_ENT,          _______,    _______,    _______,    _______,
    _______,    _______,    _______,    TD(MAKE),   _______,    _______,    _______,    KC_HOME,    KC_PGDN,    KC_PGUP,    KC_END,     _______,         _______,    _______,    _______,    _______,
    _______,    _______,    _______,    _______,    KC_ENT,     _______,    _______,    _______,    _______,    _______,    _______,    _______,         _______,    _______,    _______,    _______
  ),
...
*/ 
  ...
  [_FN2] = LAYOUT_ortho_4x12_4x4(
    KC_BRID,    KC_BRIU,    MSNCTRL,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,         _______,    _______,    _______,    _______,
    _______,    WHLSCR,     PRNTSCRC,   PRNTSCR,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,         _______,    _______,    _______,    _______,
...
*/ 
  ...
  [_FN3] = LAYOUT_ortho_4x12_4x4(
    KC_GRAVE,   GA_LEFT,    GA_RIGHT,   ALT_SUP,    ALT_SDN,    _______,    _______,    _______,    _______,    _______,    _______,    _______,         _______,    _______,    _______,    _______,
    GUI_GRV,    DELC,       INSC,       DELR,       INSR,       _______,    _______,    _______,    _______,    _______,    _______,    _______,         _______,    _______,    _______,    _______,
...
void make_therick48_finished (qk_tap_dance_state_t *state, void *user_data) {
  ...
  switch (make_therick48_state.state) {
    case SINGLE_TAP: SEND_STRING("make therick48.16:default:dfu"); break; // send therick48 default make code
    case DOUBLE_TAP: SEND_STRING("make therick48.16:macos:avrdude"); break; // send therick48 macos make code
  }
}
